...
def nlq_to_sql(nl_query):
    ...
    # Handle numeric conditions (marks, age, etc.)
    # Example: "marks above 80", "age below 20", "marks equal 100"
    ...
    if " and " in nl_query:
        ...
        sql += " AND ".join(conditions)  # default AND if multiple

    # If no condition found, select all
    if not conditions:
